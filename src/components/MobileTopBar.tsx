        ...
        <div className="flex items-center gap-1">
          ...
          <div ref={notifRef} className="relative">
            ...
            >
              <Bell size={20} />
              {unreadCount > 0 && (
                <span className="absolute top-0.5 right-0.5 min-w-[16px] h-[16px] px-1 bg-destructive text-destructive-foreground text-[9px] font-extrabold rounded-full flex items-center justify-center border-2 border-card animate-pulse shadow-sm">
